...
def get_ml_predicted_returns(date, available_permnos, df_features=None, model=None):
    """Placeholder; signals the backtest to use the shrunk historical-mean fallback."""
    return None
```
...
for t_idx, date in enumerate(oos_dates):
    ...
    ml_mu = get_ml_predicted_returns(date, permnos_w, df_ma2_feat, ma2_model)
