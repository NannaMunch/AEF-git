...
#| fig-cap: "Daily realized variances for the 30 DJIA stocks. Each line shows the diagonal element of the daily realized covariance matrix for one stock."
#| fig-align: center
#| fig-pos: "H"
...
plt.title("Daily realized variances for the 30 DJIA stocks")
plt.grid(True, alpha=0.3)

# Put legend outside the plot to avoid covering the lines
plt.legend(
    loc="center left",
